function criarContaBancaria() {
  ...
  contaBancaria.mostrarInformacoesUsuario(1)
    .then((usuario) => {
  ...
  const todosUsuarios = contaBancaria.mostrarInformacoesUsuario();
  console.log('Lista de todos os usuários:', todosUsuarios);
