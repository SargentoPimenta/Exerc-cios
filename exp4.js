function encontrarPessoaMaisVelhaEmaisNova(listaDePessoas) {
    return new Promise((resolve, reject) => {
      if (!Array.isArray(listaDePessoas) || listaDePessoas.length === 0) {
        reject(new Error('A lista de pessoas está vazia ou não é um array válido.'));
        return;
      }
  ...
  encontrarPessoaMaisVelhaEmaisNova(listaDePessoas)
    .then(({ pessoaMaisVelha, pessoaMaisNova }) => {
